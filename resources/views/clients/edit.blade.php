                    ...
                    <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                        ...
                        <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                            ...
                            <span
                                ...
                                <i class="fa-solid fa-user-pen me-2 fs-3"></i>
                                    ...
                                    <form id="add_client_form" class="form">
                                        ...
                                        <div class="row fv-row mb-5">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <input type="text" class="form-control form-control-solid" name="rg"
                                                    value="{{ $client->rg }}" />
                                                ...
                                                <select id="client_state_selector" name="state"
                                                    ...
                                                    @foreach ($states as $state)
                                                        <option value="{{ $state->id }}"
                                                            {{ $client->city->state->id == $state->id ? 'selected' : '' }}>
                                        ...
                                        <div class="row fv-row mb-7">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <input type="text" class="form-control form-control-solid"
                                                        name="street" value="{{ $client->street }}" />
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <input type="text" class="form-control form-control-solid"
                                                        name="street_number" value="{{ $client->street_number }}" />
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <input type="text" class="form-control form-control-solid"
                                                        name="neighbor" value="{{ $client->neighbor }}" />
